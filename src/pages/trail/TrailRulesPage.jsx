          ...
          <Stack gap="xl">
            <Stack gap={rem(4)}>
              ...
              <ParagraphText>
                ...
                compiuto i 18 anni di età. Tutti gli atleti devono essere in
                possesso di un certificato medico per la pratica dello sport a
                livello agonistico in corso di validità ai sensi di legge.
                Questo certificato deve essere valido alla data della gara e
                deve essere presentato al momento dell'assegnazione del numero
                di pettorale.
              </ParagraphText>
            </Stack>
            <Stack gap={rem(4)}>
            ...
            <Stack gap={rem(4)}>
              ...
              <ul>
                <li>
                  <ParagraphText>
                    Indossare in modo visibile durante tutta la gara il numero
                    di pettorale
                  </ParagraphText>
                </li>
                <li>
                  <ParagraphText>
                    Obbligo che ciascun concorrente sia dotato, alla partenza,
                    di una GIACCA ANTIVENTO. La dotazione verrà controllata a
                    fine corsa. L'atleta che venga trovato senza questo
                    indumento verrà sanzionato con una penalità di 3 minuti
                  </ParagraphText>
                </li>
                <li>
                  <ParagraphText>
                ...
                <li>
                  <ParagraphText>
                    E' raccomandato l'utilizzo di scarpe tecniche con suole
                    trail
                  </ParagraphText>
                </li>
              </ul>
            ...
            <Stack gap={rem(4)}>
              ...
              <ParagraphText>
                ...
                dell'evento stesso. La stessa società non assicura i
                partecipanti alla gara. L'organizzazione, inoltre, non risponde
                dello smarrimento, o sottrazione di effetti e/o beni personali
                lasciati incustoditi prima, durante e dopo la gara in zona
                partenza/arrivo, presso le docce, nella zona pranzo/premiazioni.
                Al momento del ritiro pettorale, l'atleta è chiamato a firmare
                un modulo di consenso informativo e contestuale liberatoria.
              </ParagraphText>
            </Stack>
            ...
            <Stack gap={rem(4)}>
              ...
              <ParagraphText>
                ...
                pertanto di gettare la spazzatura (es: bottiglie, bicchieri,
                gel) nei cassonetti allestiti lungo il percorso. I concorrenti
            ...
            <Stack gap={rem(4)}>
              ...
              <ParagraphText>
                ...
                Campodennno - Loc. Salvez e presso piazzale Caserma VVF.
              </ParagraphText>
            </Stack>
            ...
            <Stack gap={rem(4)}>
              ...
              <ParagraphText>
                ...
                qualsiasi momento è possibile correggere o cancellare questi
                dati.
              </ParagraphText>
            </Stack>
            ...
            <Stack gap={rem(4)}>
              ...
              <ParagraphText>
                ...
                sicurezza dei concorrenti e ogni qualvolta lo ritenga
                necessario, si riserva il diritto di modificare in qualsiasi
                momento il percorso e/o il posizionamento dei punti di ristoro,
                nonché l'orario di partenza e il diritto di annullare o
                sospendere la gara. I concorrenti non avranno il diritto ad
                alcun rimborso della quota di iscrizione in caso di sospensione,
                modifica o di annullamento della stessa.
              </ParagraphText>
            </Stack>
